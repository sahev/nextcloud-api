...
namespace NextCloud
{
    public class NextCloudService : IDisposable {
		...
		/// </summary>
		public Func<NextCloudService, string, Task<string>> WaitForRedirect = waitForRedirect;
		...
		/// </summary>
		static async Task<string> waitForRedirect(NextCloudService api, string state) {
...
";
	...
	public class ApiException : ApplicationException {
		public ApiException(NextCloudService api, Exception ex) : base(ex.Message, ex) {
			Request = api.LastRequest;
			Response = api.LastResponse;
		}
		public ApiException(NextCloudService api, string message) : base(message) {
			Request = api.LastRequest;
			Response = api.LastResponse;
		}
